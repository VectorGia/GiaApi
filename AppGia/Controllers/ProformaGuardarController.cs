...
namespace AppGia.Controllers
{
    ...
    [ApiController]
    public class ProformaGuardarController : ControllerBase
    {
        ...
        // GET: api/ProformaGuardar/5
        [HttpGet("{id}", Name = "GetGuardar")]
        public string Get(int id)
        {
            return "value";
        }

        // POST: api/ProformaGuardar
        [HttpPost]
